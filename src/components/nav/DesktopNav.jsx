...
export default function DesktopNav() {
    ...
    return (
        <div className="navbar text-neutral-content hidden md:flex justify-between items-center absolute">
            ...
            <button className="btn btn-outline text-base border-gray-600 hover:border-transparent hover:bg-gradient-to-r from-red-600 to-yellow-400">Members area</button>
        </div>
