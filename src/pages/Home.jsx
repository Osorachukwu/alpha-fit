...
const Home = () => {
  return (
    ...
    <div className="relative h-[90vh] sm:h-[95vh] w-full overflow-hidden">
      ...
      <div data-aos="fade-right" className="relative top-1/2 -translate-y-1/2 px-4 sm:px-6 lg:px-8 max-w-3xl mx-aut z-10 md:mt-10">
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-300 font-medium mb-6 sm:mb-8 lg:mb-10 mx-auto px-1">
